...
Provide a short disclaimer with framing_type to indicate Which parts of your analysis are the most shaped by convention or majority views? and Which are based on encoded patterns and what patterns?   

Return ONLY valid JSON in this schema: 
 { 
 "bias_score": number, // 0 = no bias, 3 = strong bias 
 "framing_type": string, // e.g. "Humanitarian Crisis", "Conflict and Consequences", "Political Scandal" AND  **Adding a disclaimer in your framing_type selected to indicate Which parts of your answer are the most shaped by convention or majority views? Which are based on encoded patters or other **
